 ...
 <div class="app-container">
      <div class="filter-container">
        <el-input v-model="listQuery.title" placeholder="商品名称" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter" />
          ...
          <el-select v-model="listQuery.goodstype" placeholder="请选择分类" style="width: 200px; left: 10px;" >
        ...
        <el-button v-waves class="filter-item" type="primary" style="margin-left: 15px;" icon="el-icon-search" @click="handleFilter">
         ...
         <router-link :to="{name:'CreateGoods'}">
          <el-button type="primary"  style="margin-left: 10px;"  plain>添加商品</el-button>
          </router-link>
    ...
    methods: {
      ...
      handleDelete(index, row) {
        ...
        this.$confirm('此操作将永久删除, 是否继续?', '提示', {
          ...
          delGoods(index.id).then(response => {
          this.$notify({
            message: '删除成功',
            type: 'success',
            duration: 2000
