 ...
 <div class="app-container">
      <div class="filter-container">
         <router-link :to="{name:'CreateBanner'}">
          <el-button type="primary"  style="margin-left: 10px;"  plain>添加Banner图</el-button>
          </router-link>
   ...
   >
     ...
     <el-table-column label="轮播图片" align="center" width="450px">
       <template slot-scope="{row}">
            <img :src="imgUrl+row.img_url" alt="" width="400px">
       </template>
     </el-table-column>
