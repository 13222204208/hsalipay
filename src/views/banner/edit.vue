...
<el-form ref="form" :model="form" :rules="rules" label-width="80px">
  ...
  <el-form-item label="跳转地址" prop="sort">
    <el-input v-model="form.skip_url"  placeholder="1 衣物, 2 书籍, 3 家电, 4 电子设备 "   style="width: 58rem;"></el-input>
  </el-form-item>
...
import { editBanner, updateBanner } from '@/api/banner'
...
export default {
  ...
  methods: {
    ...
    fetchData(id) {
      editBanner(id).then(response => {console.log(response)
    ...
    onSubmit(){
      ...
      updateBanner(this.form.id,this.form).then(response => {
          this.$message({
            message: '更新成功',
            type: 'success'
          })
